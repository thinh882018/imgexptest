/// <reference types="cypress" />
 ...
 describe('Sprint 3 Test', () => {
    ...
    it.skip('sign_up_01 - Verify that input tags are required', () => {
        // STEPS TO DO
    ...
    it.skip('sign_up_02 - Verify that your email must have domain name after "@"', () => {
        // STEPS TO DO
        // Visit the imgexp site
    ...
    it.skip('sign_up_03 - Verify that your email does not contain 2 dot(.) or 2 "@"', () => {
        // STEPS TO DO
        // Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip('sign_up_04 - Verify that your password can only contain 50 characters at most', () => {
        // STEPS TO DO
        // Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip('sign_up_05 - Verify that your password can contain 6 characters at least', () => {
        // STEPS TO DO
        // Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip('sign_up_07 - Verify that your password can contain only alphanumeric, upper case, lowercase, undercore(_) and dash(-)', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip('sign_up_08 - Verify that your email is already in use', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
